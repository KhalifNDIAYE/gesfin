...
import { useFiscalYears, useTrackingAxes } from "@/hooks/useParametrage";
...
export default function AffectationActivitePage() {
  ...
  const handleSubmit = () => {
    createMutation.mutate({
      ...
      onSuccess: () => {
        ...
        setFormData({ activity_id: "", amount: "", percentage: "", description: "" });
      }
    });
  };
  ...
  return (
    <AppLayout 
      title="Affectation par Activité" 
      subtitle="Répartition des charges par activité"
    >
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Gérez la répartition des charges par activité</CardDescription>
              </div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Nouvelle Affectation par Activité</DialogTitle>
            <DialogDescription>
              Créez une nouvelle affectation de charges par activité
            </DialogDescription>
          </DialogHeader>
