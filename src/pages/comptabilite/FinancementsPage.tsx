...
import { Plus, Search, Download, Upload, CreditCard } from "lucide-react";
...
export default function FinancementsPage() {
  ...
  return (
    <AppLayout 
      title="Saisie des Financements" 
      subtitle="Enregistrement des financements reçus"
    >
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <CardDescription>Liste des écritures de financements</CardDescription>
                </div>
              </div>
