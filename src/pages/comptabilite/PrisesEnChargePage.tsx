...
import { Plus, Search, Download, Upload, FileCheck } from "lucide-react";
...
export default function PrisesEnChargePage() {
  ...
  return (
    <AppLayout 
      ...
      subtitle="Enregistrement des prises en charge comptables"
    >
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <CardDescription>Liste des écritures de prises en charge</CardDescription>
                </div>
              </div>
